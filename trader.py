...
class Trader:
    def __init__(self, stock: Stock, timeout:float = 30.0):
        self.stock = stock
...
if __name__ == "__main__":
    with TwsConnection() as conn:
        stock = Stock(conn, symbol="RHM", exchange="SMART", currency="EUR", primaryExchange="IBIS")
        trader = Trader(stock)

        # Place a market buy
        trade = trader.buy(10, order_type='MKT', wait=True)
